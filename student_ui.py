...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.address)
        ...
        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.phone)

        self.add_data = QPushButton(self.centralwidget)
        self.add_data.setObjectName(u"add_data")

        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.add_data)
        ...
        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.delete_2)
