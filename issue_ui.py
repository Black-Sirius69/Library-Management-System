...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.book_no, 3, 1, 1, 1)

        self.issue_date = QDateEdit(self.centralwidget)
        self.issue_date.setObjectName(u"issue_date")
        self.issue_date.setCalendarPopup(True)

        self.gridLayout.addWidget(self.issue_date, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.stu_no, 2, 1, 1, 1)
